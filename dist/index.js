...
const apartment_1 = __importDefault(require("./routers/apartment"));
const cors_1 = __importDefault(require("cors"));
const body_parser_1 = __importDefault(require("body-parser"));
Promise.resolve().then(() => __importStar(require("./database/connect")));
...
app.use("/apartment", apartment_1.default);
app.listen(port, () => {
